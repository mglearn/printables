#!/usr/bin/env bash
# Generates a print-ready 2-page PDF next to every supplemental-aid PNG (same name, .pdf):
#   page 1 = the original color cue-card sheet
...
# (needed after changing the output format). Run from printables/supplemental_aids/.
set -euo pipefail
cd "$(dirname "$0")"
